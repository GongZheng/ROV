...
import com.yyl.videolist.VideoPlayer;
...
public class PiVideoView extends TextureView implements MediaPlayerControl, TextureView.SurfaceTextureListener, VideoSizeChange {
    private PiVideoPlayer videoMediaLogic;
    ...
    public PiVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PiVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        if (!isInEditMode()) {
            videoMediaLogic = new PiVideoPlayer(context);
