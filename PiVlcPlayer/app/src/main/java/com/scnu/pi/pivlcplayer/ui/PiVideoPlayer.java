...
public class PiVideoPlayer implements MediaPlayerControl, Handler.Callback, IVLCVout.Callback {
    private static final HandlerThread sThread = new HandlerThread("PiVlcVideoPlayThread");
    private Handler mVideoHandler;
    private static final int MSG_START = 0x0008;
    private static final int MSG_STOP = 0x0009;

    private String TAG = "PiVideoMediaLogic";
    ...
    public boolean handleMessage(Message msg) {
        synchronized (PiVideoPlayer.class) {
            switch (msg.what) {
                case MSG_START:
    ...
    public PiVideoPlayer(Context context) {
    ...
    private String path;
    private final String tag = "PiVideoMediaLogic";
