...
from four_wheel_device import FourWheelDevice as FWD
...
class MovementServer(object):
	"""docstring for MovementServer"""
	# def __init__(self):
	# 	# super(MovementServer, self).__init__()

	def __del__(self):
		print("stop MovementServer")
		self.exit()
		GPIO.cleanup()
	...
	def run(self):
		...
		server = HTTPServer(('0.0.0.0', 81), GetHandler)
